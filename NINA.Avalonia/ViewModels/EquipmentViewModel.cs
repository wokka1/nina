...
/// type's own VM straight through). Camera, Telescope, FilterWheel, Focuser, Rotator, and Dome
/// are wired up so far - the other 5 device types (Guider/Switch/FlatDevice/WeatherData/
...
public partial class EquipmentViewModel : ViewModelBase {
    public EquipmentViewModel(ICameraVM cameraVM, ITelescopeVM telescopeVM, IFilterWheelVM filterWheelVM, IFocuserVM focuserVM, IRotatorVM rotatorVM, IDomeVM domeVM) {
        CameraVM = cameraVM;
