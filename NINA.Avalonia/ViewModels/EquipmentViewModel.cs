...
/// type's own VM straight through). Camera, Telescope, FilterWheel, and Focuser are wired up
/// so far - the other 7 device types (Rotator/Dome/Guider/Switch/FlatDevice/WeatherData/
...
public partial class EquipmentViewModel : ViewModelBase {
    public EquipmentViewModel(ICameraVM cameraVM, ITelescopeVM telescopeVM, IFilterWheelVM filterWheelVM, IFocuserVM focuserVM) {
        CameraVM = cameraVM;
