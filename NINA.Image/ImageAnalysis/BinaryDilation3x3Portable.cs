...
namespace NINA.Image.ImageAnalysis {
    ...
    /// <summary>
    /// Portable, Bitmap/GDI+-free entry point for Accord.Imaging's BinaryDilation3x3 filter -
    /// see CannyEdgeDetectorPortable for the rationale behind the double-clone (source-copy
    /// plus pre-filled destination) pattern used to reproduce ApplyInPlace's semantics.
    /// </summary>
    public class BinaryDilation3x3Portable : BinaryDilation3x3 {
